...
Cypress.Commands.add( 'resetSite', () => {
	...
	cy.exec( 'wp db query \'DELETE FROM wp_options WHERE option_name IN ( "coil_general_settings_group", "coil_exclusive_settings_group", "streaming_widget_settings_group", "coil_db_ver");\' --allow-root' );
