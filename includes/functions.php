...
function load_full_assets() : void {
	...
	$strings = apply_filters(
		...
		[
			...
			'unable_to_verify'        => empty( Admin\get_messaging_settings( 'coil_unable_to_verify_message_id' ) ) ? Admin\get_messaging_settings( 'coil_unable_to_verify_message_id', true ) : Admin\get_messaging_settings( 'coil_unable_to_verify_message_id' ),
			'voluntary_donation'      => empty( Admin\get_messaging_settings( 'coil_voluntary_donation_message_id' ) ) ? Admin\get_messaging_settings( 'coil_voluntary_donation_message_id', true ) : Admin\get_messaging_settings( 'coil_voluntary_donation_message_id' ),
