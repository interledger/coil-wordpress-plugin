...
function load_full_assets() : void {
	...
	$strings = apply_filters(
		...
		[
			...
			'paywall_button_link'     => Admin\get_paywall_appearance_text_settings_or_default( 'coil_paywall_button_link' ),
			...
			'font_selection'          => Admin\get_inherited_font_setting( 'coil_message_font' ),
