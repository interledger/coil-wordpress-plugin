...
function load_full_assets() : void {
	...
	$strings = apply_filters(
		...
		[
			...
			'unable_to_verify'        => Admin\get_messaging_settings( 'coil_unable_to_verify_message_id', true ),
			'voluntary_donation'      => Admin\get_messaging_settings( 'coil_voluntary_donation_message_id', true ),
			'loading_content'         => Admin\get_messaging_settings( 'coil_pending_message_id', true ),
			'fully_gated'             => Admin\get_messaging_settings( 'coil_fully_gated_content_id', true ),
			'partial_gating'          => Admin\get_messaging_settings( 'coil_partially_gated_content_id', true ),
