...
/**
 * @return array Valid padlock sizes.
 */
function get_padlock_title_icon_size_options() {
...
function get_exlusive_icon_setting( $field_id ) {
	...
	$padloack_settings = [ 'coil_padlock_icon_position', 'coil_padlock_icon_style', 'coil_padlock_icon_size' ];
